...
for item in old:
 ...
 shutil.copy2(BASE/'masters'/(item['id']+'.png'),ROOT/'masters'/(item['id']+'.png'))
...
('emoji','exec-339292c4-8c33-4782-85ec-45e8129fde00.png',['grin','rofl','tongue','relieved','skeptical','unamused','pleading','starry'],['Улыбка до ушей','Не могу со смеху','Дразнюсь','Выдохнул','Серьёзно?','Не впечатлён','Ну пожалуйста','Восторг'])]
new=[]
...
with ThreadPoolExecutor(max_workers=3) as pool:
 for kind,filename,names,labels in NEW:
  ...
  for index,name in enumerate(names):
   ...
   item={'id':kind+'-'+name,'label':labels[index],'kind':kind,'cycle_ms':4000,'fps':25,'added_in':'04','size_webp':[512,512]}
...
print('56 standard animations and 56 PNG 2K masters ready',flush=True)
