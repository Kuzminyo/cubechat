...
class AppLocalizationsUk extends AppLocalizations {
  ...
  @override
  String get editorToolDraw => 'Малюнок';
  ...
  @override
  String get pushWakeDeniedTitle => 'Сповіщення вимкнені';
  ...
  String chatForwardSentCount(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Переслано в $count чатів',
      few: 'Переслано в $count чати',
      one: 'Переслано в один чат',
    );
    return '$_temp0';
  }
  ...
  String presenceHoursAgo(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'був(ла) $count години тому',
      many: 'був(ла) $count годин тому',
      few: 'був(ла) $count години тому',
      one: 'був(ла) $count годину тому',
    );
    return '$_temp0';
  }
