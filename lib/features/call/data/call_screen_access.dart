...
///
/// Android re-decides the full-screen permission when an APK is installed over
/// itself from outside Google Play, and MIUI does the same with its lock-screen
/// one — so after every sideloaded update both are off, in the system settings
/// too, and no app can grant either back to itself. Build 1090 asked about it
/// with a sheet on the chats screen after each update; the owner had it taken
/// out ("его не должно быть"). The switch in Profile shows what Android says
/// and opens the page that changes it, and that is the whole of it now.
@immutable
